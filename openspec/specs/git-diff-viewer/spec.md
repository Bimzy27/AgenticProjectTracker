...
Show readable, categorized git diffs for tracked projects: uncommitted working-tree changes and comparisons between branches or arbitrary refs, kept current as the repository changes.
