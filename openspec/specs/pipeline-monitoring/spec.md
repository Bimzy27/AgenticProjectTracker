...
Monitor GitHub Actions pipelines for tracked projects: rate-limit-aware polling, per-project status display, failure notifications, and secure GitHub token handling.
